"""Mega Lucario ex heuristic -- THIRD-PARTY PUBLIC AGENT, used as an offline opponent only.

Source notebook : https://www.kaggle.com/code/aristophanivan/probablity-v2
Licence         : Apache-2.0 (public Kaggle notebook)
publicScore     : 933.8 (read 2026-07-23)

...
Prints per-seat and combined win rates. Remember the project rule: offline win
rates systematically overrate — use this to catch regressions and rank candidate
changes, then confirm on the real ladder.
"""
import os
import sys

"""Search-audited Alakazam -- THIRD-PARTY PUBLIC AGENT, used as an offline opponent only.

Source notebook : https://www.kaggle.com/code/prvsiyan/ptcg-ai-battle-search-audited-alakazam-v9
Licence         : Apache-2.0 (public Kaggle notebook)
publicScore     : 778.2 (read 2026-07-23)
...
USE_SEARCH = False  # forced OFF for component isolation (analysis)

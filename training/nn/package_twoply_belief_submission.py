"""Package the 2-ply search agent (BELIEF determinization) as a SELF-CONTAINED Kaggle submission.
...
def main():
    ...
    ap.add_argument("--out-dir", default=os.path.join(_REPO, "training", "twoply_belief_submission"))
    args = ap.parse_args()
